...
function Invoke-GitFlowInit ([switch]$Force) {
    ...
    if(!($initialised) -or $Force) {
        ...
        $out = Invoke-RunProcessCatchErrors -Command "git config gitflow.prefix.versiontag"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUQPFu13H8U1wZBfS+wmOSet/5
# yhagggY1MIIGMTCCBRmgAwIBAgIKYf5LqwAAAAACwjANBgkqhkiG9w0BAQUFADBt
...
# AgEVMCMGCSqGSIb3DQEJBDEWBBSK3AJ2LNXeKRfLL+jhQQwZm197MzANBgkqhkiG
# 9w0BAQEFAASCAQAFK/Ssl5G1+HJ/9DC8w0S5r3BEdpKVYqMasfpGHFumlouGILfP
# GoQvH//ym1jexQdQtvVawt87eAeWdkZ2vG5kan9G3SEx2VejOKcNGXcmu16XVeCM
# zY1CTWsI3EaqMbaRvz5BUfZzK7IpVBN8MTQy6h/+KYLUEdJHk2eVbmMbP2CnsmVl
# U8qT9MbOZKE3srjYvjK02Ztd949NuPLJW+3n1a/Lnn0NwbIiu3cZ/0IC0O+wCLkn
# 5B+xkg14SxKDR5hipGUDvrc4/s2YBBbLfglxy72ESMOq/tgoeZV2DJ/lT27ETPI1
# 4BibRQ1/FYju+dQ4IvPFuBpNmLtlcdwZU1mb
